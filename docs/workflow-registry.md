...
Request
  ...
  +-- Non-trivial work
        ...
        -> Plan Update as required + Project In Progress after Human confirmation
...
For non-trivial user-visible frontend work, the UI quality loop is distributed
by responsibility: `docs/design/desktop-ui-guide.md` owns durable desktop
rules, `docs/design/ux-workflow.md` owns the checklist and loop,
`prompts/design-ux.md` collects bounded findings, the frontend implementation
skill collects planned runtime evidence, and implementation review determines
whether unresolved material findings block acceptance. This is process routing,
not a new workflow service or design system.
...
| Experimental multi-stage route authoring | Skill | `soundatlas-experimental-route-authoring` |
...
| UX audit and critique                   | Prompt                                 | Inspection before implementation; Grill-Me before Issue planning when needed | `docs/design/desktop-ui-guide.md`, `docs/design/current-frontend-design.md`, explicitly referenced target mockups, and relevant audit | `prompts/design-ux.md` | Findings, UX slice, or audit with bounded UI-quality evidence |
