...
The documentation and testing prompts remain compatibility wrappers until their
corresponding skill Issues are completed. The frontend implementation prompt is
now a compatibility wrapper for the completed frontend skill. `grill-me.md`
